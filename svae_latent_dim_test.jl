...
outputFolder = mainfolder * "results/svae_latent_dim_test/"
mkpath(outputFolder)
...
gridsearch(evaluateOneConfig, [64], [2, 3, 4, 5, 6, 7, 8, 9], [3], ["swish"], ["Dense"], [16], Float32.([0.01, 0.1, 1.]), Float32.([1., 0.1, 0.01, 0.001]))
